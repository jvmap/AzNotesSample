...
Note: the name of the storage account needs to be unique within all of Azure. To make the account name unique, you can append `${suffix}` to the name you have chosen. This adds 13 pseudorandom characters to the storage account name. The same strategy is used for the `appService` resource name.
